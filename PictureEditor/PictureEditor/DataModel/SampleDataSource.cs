...
namespace PictureEditor.Data
{
    ...
    public abstract class SampleDataCommon : PictureEditor.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            var group1 = new SampleDataGroup("Controls",
                    "Group Title: 1",
                    "Group Subtitle: 1",
                    "Assets/DarkGray.png",
                    "Group Description: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus tempor scelerisque lorem in vehicula. Aliquam tincidunt, lacus ut sagittis tristique, turpis massa volutpat augue, eu rutrum ligula ante a ante");
            group1.Items.Add(new SampleDataItem("Controls1",
                    "Take Picture",
                    "",
                    "Pictures/Camera-icon.png",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT,
                    group1));
            group1.Items.Add(new SampleDataItem("Controls2",
                    "Pick Picture",
                    "",
                    "Pictures/photoLib.png",
                    "Item Description: Pellentesque porta, mauris quis interdum vehicula, urna sapien ultrices velit, nec venenatis dui odio in augue. Cras posuere, enim a cursus convallis, neque turpis malesuada erat, ut adipiscing neque tortor ac erat.",
                    ITEM_CONTENT,
                    group1));
            ...
            var group2 = new SampleDataGroup("Recent Pictures",
                    "Recent Pictures",
                    "",
        ...
        public void addImage(String name, String uri, SampleDataGroup group)
        {
            group.Items.Add(new SampleDataItem(name + "id", name, "", uri, "", "", group));
        }
